...
#---------------------------------------------------------------------------------------------------------------------
# [+] wpscry
#     wpscry adalah sebuah script bash sederhana yang dirancang untuk melakukan serangan terhadap jaringan Wi-Fi yang menggunakan fitur WPS (Wi-Fi Protected Setup) dengan alat reaver.
#
# [+] Pembuat
#     - Ropay
# 
